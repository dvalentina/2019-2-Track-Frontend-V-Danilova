...
template.innerHTML = `
  <style>
    .chat-header {
      ...
      box-shadow: 0 0.8vh 1.5vh 0 rgba(0, 0, 0, 0.5);
      position: relative;
      z-index: 1;
    }
  ...
  <div class="chatlist-header">
    <button class="button-menu">
      <svg class="button-svg" version="1.1" position="absolute" id="button-menu-svg" fill="white" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="20px" y="20px"
    ...
    <button class="button-search">
      <svg class="button-svg" margin-right="0.5vh" version="1.1" id="chatlist-button-search" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="40px" y="40px"
  ...
  <div class="chat-header">
    <button class="button-return">
      <svg class="button-svg" fill="white" height="60px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <div class="user-avatar">
      <svg class="user-avatar-svg" viewBox="0 0 480 480" fill="white" xmlns="http://www.w3.org/2000/svg">
    ...
    <button class="button-search">
      <svg class="button-svg" version="1.1" id="Capa_1" height="60px" width="60px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 451 451" style="enable-background:new 0 0 451 451;" xml:space="preserve">
        <g>
          <path d="M447.05,428l-109.6-109.6c29.4-33.8,47.2-77.9,47.2-126.1C384.65,86.2,298.35,0,192.35,0C86.25,0,0.05,86.3,0.05,192.3
          s86.3,192.3,192.3,192.3c48.2,0,92.3-17.8,126.1-47.2L428.05,447c2.6,2.6,6.1,4,9.5,4s6.9-1.3,9.5-4
    ...
    <button class="button-options">
      <svg class="button-svg" height="60px" version="1.1" id="button-options" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
